...
def ensure_schema(*, engine_override: Optional[Engine] = None) -> None:
    ...
    model_columns = {
        ...
        "comparability_assessments": {
            "id": "INTEGER",
            "left_scope_type": "TEXT",
            "left_scope_id": "INTEGER",
            "right_scope_type": "TEXT",
            "right_scope_id": "INTEGER",
            "status": "TEXT",
            "rule_id": "TEXT",
            "cited_measurement_keys_json": "TEXT",
            "cited_snapshot_ids_json": "TEXT",
            "as_of": "TEXT",
            "policy_id": "TEXT",
            "policy_version": "TEXT",
            "policy_package_hash": "TEXT",
        ...
        "report_runs": {
            ...
            "as_of": "TEXT",
            "policy_pins_json": "TEXT",
            "snapshot_coverage_json": "TEXT",
            "payload_json": "TEXT",
            "created_at": "TEXT",
        },
        "policy_upgrade_sessions": {
            "id": "INTEGER",
            "old_policy_pins_json": "TEXT",
            "new_policy_pins_json": "TEXT",
            "delta_payload_json": "TEXT",
            "operator_acknowledged": "INTEGER",
            "created_at": "TEXT",
