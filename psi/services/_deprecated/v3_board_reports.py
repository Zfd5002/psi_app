...
"""DEPRECATED: historical board-report path.

This module is intentionally not router-wired in V3 runtime surfaces.
It is retained under `psi.services._deprecated` for reference only.
"""
